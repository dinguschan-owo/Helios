...
function createCenterSitechecker() {
        ...
        if (!centerSitecheckerContainer) {
            ...
            centerSitecheckerContainer.innerHTML = `
                ...
                <p id="sitechecker-center-text">Hey there! dinguschan speaking! I'm excited to introduce the brand-new <strong>GUST</strong> - which is litrally just Helios but BETTER, developed by the Nautilus Labs team. Nearly every issue you guys begged to be solved was solved in GUST, along with a stunning new UI and a much more powerful rendering engine! It still runs fully within a single HTML file, so the unblockable nature of Helios is preserved. Check it out now, and don't forget to star!</p>
